...
void read_variables(void * parameter) {
  while (true) {
    ...
    // Serial.println("TEMP: " + String(temp) + ", SPEED: " + String(speed) + ", ANGLE: " + String(angle) + ", IS_BACKED_PRESSED: " + String(is_back_pressed)); // chỉ uncomment khi muốn đọc giá trị
    }
